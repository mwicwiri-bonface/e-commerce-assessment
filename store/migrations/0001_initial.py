    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publish', models.BooleanField(default=False, help_text='Publish, allow to display', verbose_name='Publish')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.ImageField(choices=[(1, 'One star'), (2, 'Two star'), (3, 'Three star'), (4, 'Four star'), (5, 'Five star')], default=5, upload_to='')),
